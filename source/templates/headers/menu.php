<nav>
        ...
        <div class="nav-links" id="navLinks">
            ...
            <ul>
                ...
                <!--TODO: dodać route'a z url= 'claimtracker/index'-->
                <li><?php 
                    if (isset($_SESSION['logged_user']) && $_SESSION['logged_user'])
                        echo('<a href="' . $this->generateUrl('claimtracker/index') . '">ClaimTracker</a></li>');
                    else
                        echo('<a href="' . $this->generateUrl('login/index') . '">ClaimTracker</a></li>');
                ?>
                ...
                <li><?php 
                    if (isset($_SESSION['logged_user']) && $_SESSION['logged_user'])
                        echo('<a href="' . $this->generateUrl('registration/accdelete') . '">DELETE ACCOUNT</a></li>');
                ?>
            </ul>
        </div>
